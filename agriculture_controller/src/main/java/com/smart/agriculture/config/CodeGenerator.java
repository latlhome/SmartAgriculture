...
//
//         String [] modules = new String[]{"meeting_pojo", "meeting_mapper", "meeting_service", "meeting_controller"};//项目模块名，需自定义
...
//                 return new File("meeting_mapper").getAbsolutePath()+ "/src/main/resources/mapper/" + tableInfo.getEntityName()
...
//         } else if ("meeting_mapper".equals(module)){
...
//                     .setServiceImpl(null)
//                     .setController(null);
//         } else if ("meeting_service".equals(module)){
//             templateConfig.setEntity(null)
//                     .setMapper(null)
//                     .setXml(null)
...
//                     .setController(null);
//         } else if ("meeting_controller".equals(module)){//web模块只生成controller代码
//             templateConfig.setEntity(null)
//                     .setMapper(null)
//                     .setXml(null)
//                     .setService(null)
...
//         String dbUrl = "jdbc:mysql://127.0.0.1:3306/meeting_backend?useSSL=false&serverTimezone=GMT%2B8&characterEncoding=utf8&allowPublicKeyRetrieval=true";
...
//                 .setAuthor("jiangzhuohang");  //使用时，更改为自己的昵称
//         return globalConfig;
//     }
// }
